...
export const cssDirect : dynamic = {
    ...
    "abc": "top:50%;left:50%;--abc-x:-50%;--abc-y:-50%;translate:calc(var(--abc-x) + var(--fx-x, 0px)) calc(var(--abc-y) + var(--fx-y, 0px));",
    ...
    "center-h": "left: 50%;--abc-x: -50%;translate: calc(var(--abc-x) + var(--fx-x, 0px)) var(--fx-y, 0px);",
    "center-x": "left: 50%;--abc-x: -50%;translate: calc(var(--abc-x) + var(--fx-x, 0px)) var(--fx-y, 0px);",
    "center-v": "top: 50%;--abc-y: -50%;translate: var(--fx-x, 0px) calc(var(--abc-y) + var(--fx-y, 0px));",
    "center-y": "top: 50%;--abc-y: -50%;translate: var(--fx-x, 0px) calc(var(--abc-y) + var(--fx-y, 0px));",
