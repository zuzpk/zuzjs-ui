...
const Button = forwardRef((props, ref) => {
    ...
    return _jsxs("button", { className: `${reset ? `flex` : `--button --${size || Size.Small} flex aic jcc`} ${icon ? `ico-btn` : ``} ${className}`.trim(), style: style, ref: ref, ...rest, children: [state == ButtonState.Loading && _jsx(Spinner, { size: Size.Small, color: `#ffffff`,
